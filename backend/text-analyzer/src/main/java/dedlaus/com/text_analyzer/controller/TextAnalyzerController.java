...
public class TextAnalyzerController {
    ...
    public ResponseEntity<Map<String, Long>> analyzeText(@RequestBody String text, @RequestBody AnalysisMode analysisMode) {
        Map<String, Long> result = textAnalyzerService.analyzeText(text, analysisMode);
